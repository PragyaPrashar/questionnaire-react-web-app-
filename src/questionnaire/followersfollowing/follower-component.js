...
import {removeUserThunk, unfollowUserThunk} from "./following-followers-thunk";

const FollowerComponent = ({userObj})=>{
    ...
    const setRemoveFollowHandler=()=>{
        ...
        console.log("userObj in remove handler is ",userObj)


        const RemoveUserId=userObj._id
        console.log("followUserId to be removed is ",RemoveUserId)
        const obj = {
            loggedInUserId: currentLoggedInUser._id,
            anotherUserId : RemoveUserId
        }
        dispatch(removeUserThunk(obj))
    }
...

            {
                ...
                <div className="row mt-2 border-bottom shadow-sm ">
                    ...
                    <div className="col-3 ">
                        ...
                        <button className="w-50 wd-bttn wd-btn-color text-light border-0 shadow rounded-pill  mt-3 " onClick={setRemoveFollowHandler}>Remove</button>
