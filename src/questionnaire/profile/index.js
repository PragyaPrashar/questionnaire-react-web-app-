...
const Profile = (
    ...
    //         dob: "4 Nov 1995",
    //         address: "1185 Boylston Street, Apt No. 48, Boston, Massachusetts, 02215, United
    // States of America", password: "123", questionsAsked: [1, 2, 3, 4], answersAnswered: [5, 6,
    // 7, 8], followers: [9, 10, 11, 12], following: [13, 14, 15, 16], comments: [16, 18, 19, 20] }
    // }
) => {
